...
@section('content')
<section class="hero position-relative" style="background: url('{{ asset('assets/images/hero.jpg') }}'); background-size: cover; background-position: center">
    <div class="container text-white py-5">
        ...
        <a class="continue text-gray-400 position-absolute bottom-0 mb-5 z-index-20 link-transition small text-uppercase" href="#intro"><i class="fas fa-long-arrow-alt-down"></i> Scroll Down</a>
    </div>
</section>
<section id="intro">
    <div class="container">
...
<!-- Header for Blog Titles -->
<div class="container text-center mb-3 text-decoration-underline text-uppercase">
    <h3>Blog Category</h3>
</div>

<div class="container mb-5 owl-carousel">
